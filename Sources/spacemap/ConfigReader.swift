...
let content = """
        ...
        SHOW_SPACE_NUMBERS=\(d.showSpaceNumbers ? "on" : "off")              # on | off
        SHOW_SPACE_NAMES=\(d.showSpaceNames ? "on" : "off")              # on | off
        SHOW_ICON_STRIP=\(d.showIconStrip ? "on" : "off")              # on | off
        SHOW_MULTI_APP_ICONS=\(d.showMultiAppIcons ? "on" : "off")       # on | off
